  ...
  function (movie) {
    ...
    movieDetail.innerHTML = `
      <div
        ...
        style="background-image: url(${imageBase_url}w1280${
    ...
    fetchDataFromServer(
      `https://api.themoviedb.org/3/movie/${movieId}/recommendations?api_key=76740fcc7dbc4a857c786802cbf10e1c&page=1`,
      adddSuggestedMovies
    );
  }
);
const adddSuggestedMovies = function ({ results: movieList }, title) {
  ...
  for (const movie of movieList) {
    const movieCard = createMovieCard(movie); //call from move-card js
